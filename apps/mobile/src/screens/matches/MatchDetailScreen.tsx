    ...
    <View style={styles.topSection}>
      ...
      <View style={{ flexDirection: 'row', gap: 10, marginTop: 12 }}>
        <View style={{ flex: 1, backgroundColor: colors.surface, borderRadius: 16, paddingVertical: 16, alignItems: 'center', borderWidth: 1, borderColor: colors.surfaceBorder }}>
          <Text style={{ fontSize: 22, fontWeight: '700', color: palette.purple[600], paddingHorizontal: 4, textAlign: 'center', width: '100%' }}>{(selectedMatch as unknown as { postCount?: number }).postCount ?? 0}</Text>
        ...
        <View style={{ flex: 1, backgroundColor: colors.surface, borderRadius: 16, paddingVertical: 16, alignItems: 'center', borderWidth: 1, borderColor: colors.surfaceBorder }}>
          <Text style={{ fontSize: 22, fontWeight: '700', color: palette.purple[600], paddingHorizontal: 4, textAlign: 'center', width: '100%' }}>{(selectedMatch as unknown as { followerCount?: number }).followerCount ?? 0}</Text>
        ...
        <View style={{ flex: 1, backgroundColor: colors.surface, borderRadius: 16, paddingVertical: 16, alignItems: 'center', borderWidth: 1, borderColor: colors.surfaceBorder }}>
          <Text style={{ fontSize: 22, fontWeight: '700', color: palette.purple[600], paddingHorizontal: 4, textAlign: 'center', width: '100%' }}>{(selectedMatch as unknown as { followingCount?: number }).followingCount ?? 0}</Text>
