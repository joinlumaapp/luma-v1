    ...
    <View style={styles.topSection}>
      ...
      <View style={{ flexDirection: 'row', backgroundColor: colors.surface, borderRadius: 12, paddingVertical: 14, marginTop: 8 }}>
        <View style={{ flex: 1, alignItems: 'center' }}>
          <Text style={{ fontSize: 18, fontWeight: '700', color: colors.text }}>{(selectedMatch as unknown as { postCount?: number }).postCount ?? 0}</Text>
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          <Text style={{ fontSize: 18, fontWeight: '700', color: colors.text }}>{(selectedMatch as unknown as { followerCount?: number }).followerCount ?? 0}</Text>
          <Text style={{ fontSize: 10, fontWeight: '500', color: colors.textTertiary, marginTop: 2 }}>TAKİPÇİ</Text>
        </View>
        <View style={{ width: 1, height: 24, backgroundColor: colors.surfaceBorder, alignSelf: 'center' }} />
        <View style={{ flex: 1, alignItems: 'center' }}>
          <Text style={{ fontSize: 18, fontWeight: '700', color: colors.text }}>{(selectedMatch as unknown as { followingCount?: number }).followingCount ?? 0}</Text>
