  ...
  const content = (
    <View style={[{
      ...
      <Text style={{
        ...
        fontSize: isLarge ? 13 : 10, fontWeight: '800', color: colorInfo.text,
    ...
    <View style={{
      ...
      <View style={{
        ...
        <View style={{
          ...
          <Text style={{ fontSize: 18, fontWeight: '900', color: GOLD, lineHeight: 24 }}>{count}</Text>
        </View>
      </View>
    </View>
    <Text style={{
      fontSize: 9, fontWeight: '700', color: TEXT_MUTED, letterSpacing: 1,
  ...
  const content = (
    <View style={{
      ...
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingTop: 2 }}>
        <Text style={{
          fontSize: 24, fontWeight: '900', color: tileColor,
          lineHeight: 30,
                ...
                <View style={st.tableInner}>
                  ...
                  <View style={{ alignItems: 'center', gap: 4 }}>
                    ...
                    <View style={{
                      ...
                      <Text style={{ fontSize: 28, fontWeight: '900', color: palette.purple[400], lineHeight: 34 }}>
                        {okeyPileCount}
                      </Text>
                    </View>
                  </View>
...
const st = StyleSheet.create({
  ...
  liveText: { fontSize: 7, fontWeight: '800', color: GOLD, letterSpacing: 1, lineHeight: 12 },
  ...
  playerInitial: { fontSize: 16, fontWeight: '700', color: '#FFFFFF', lineHeight: 22 },
  activeIndicator: {
  ...
  playerScore: { fontSize: 9, fontWeight: '700', color: GOLD, lineHeight: 14 },
  ...
  turnText: {
    fontSize: 13, fontWeight: '700', color: TEXT_SECONDARY, letterSpacing: 0.5, lineHeight: 18,
  },
  ...
  specInitial: { fontSize: 8, fontWeight: '700', color: TEXT_SECONDARY },
  specOverflow: { backgroundColor: GOLD_SUBTLE, borderColor: GOLD_BORDER },
  specOverflowText: { fontSize: 7, fontWeight: '800', color: GOLD },
  ...
  gameTabLabel: { fontSize: 10, fontWeight: '700', color: TEXT_MUTED, letterSpacing: 1.5, lineHeight: 14 },
  ...
  handCountText: { fontSize: 10, fontWeight: '800', color: GOLD, lineHeight: 14 },
  sectionLabel: {
    fontSize: 9, fontWeight: '800', color: TEXT_MUTED,
    letterSpacing: 2, lineHeight: 14, paddingLeft: 4,
  },
  handScroll: { paddingHorizontal: spacing.sm, paddingVertical: 8 },
  pileLabel: { fontSize: 8, fontWeight: '700', color: TEXT_MUTED, letterSpacing: 1.5, lineHeight: 14 },
  ...
  statValue: { fontSize: 16, fontWeight: '800', color: TEXT_PRIMARY, lineHeight: 22 },
  statLabel: { fontSize: 8, fontWeight: '700', color: TEXT_MUTED, letterSpacing: 1, lineHeight: 14 },
  ...
  actionPillText: {
    fontSize: 11, fontWeight: '800', color: PURPLE_DEEP, letterSpacing: 1.5, lineHeight: 16,
  },
  ...
  chatToggleText: { fontSize: 12, fontWeight: '600', color: GOLD, lineHeight: 16 },
  ...
  lobbyTitle: { fontSize: 20, fontWeight: '800', color: TEXT_PRIMARY, letterSpacing: 1, lineHeight: 28 },
  ...
  tableCardName: { fontSize: 15, fontWeight: '700', color: TEXT_PRIMARY, lineHeight: 20 },
  tableCardType: { fontSize: 10, fontWeight: '600', color: TEXT_MUTED, letterSpacing: 1, lineHeight: 14 },
  tableLiveBadge: {
  ...
  tableLiveText: { fontSize: 8, fontWeight: '800', color: '#4ADE80', letterSpacing: 1, lineHeight: 12 },
  ...
  tableSeatInitial: { fontSize: 13, fontWeight: '700', color: '#FFFFFF' },
  tableSeatCount: { fontSize: 10, fontWeight: '600', color: TEXT_MUTED, marginLeft: 4, lineHeight: 14 },
  ...
  tableWatchText: { fontSize: 11, fontWeight: '600', color: TEXT_SECONDARY, lineHeight: 16 },
  tableJoinBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 4,
    paddingHorizontal: 16, paddingVertical: 7, borderRadius: borderRadius.full,
  },
  tableJoinText: { fontSize: 11, fontWeight: '700', color: '#FFFFFF', lineHeight: 16 },
  tableFullBadge: {
    paddingHorizontal: 12, paddingVertical: 7, borderRadius: borderRadius.full,
    backgroundColor: 'rgba(255,255,255,0.05)',
  },
  tableFullText: { fontSize: 11, fontWeight: '600', color: TEXT_MUTED, lineHeight: 16 },
  ...
  createTableText: { fontSize: 14, fontWeight: '800', color: PURPLE_DEEP, letterSpacing: 0.5, lineHeight: 20 },
  ...
  spectatorBannerText: { fontSize: 11, fontWeight: '600', color: GOLD, lineHeight: 16 },
});
