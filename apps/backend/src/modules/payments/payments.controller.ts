...
export class PaymentsController {
  ...
  @Public()
  @Get('packages')
  @ApiOperation({ summary: 'Get all subscription packages (4 tiers) and gold packs' })
  async getPackages() {
  ...
  @Get('status')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get current subscription status, tier, expiry, gold balance' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Upgrade package tier (Free -> Gold -> Pro -> Reserved)' })
  ...
  @Post('gold/purchase')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Purchase a gold pack (gold_50, gold_150, gold_500, gold_1000)' })
  async purchaseGold(
    @CurrentUser('sub') userId: string,
  ...
  @Post('gold/spend')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Spend gold on an action (harmony_extension, profile_boost, super_like)' })
  async spendGold(
    @CurrentUser('sub') userId: string,
