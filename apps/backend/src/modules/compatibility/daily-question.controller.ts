...
export class DailyQuestionController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns a different compatibility question each day, cycling through all 45 questions.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "Submit an answer to the daily question. Each question can only be answered once per day.",
  })
  ...
  @ApiOperation({
    ...
    description:
      "After answering, shows the percentage of your matches who gave the same answer.",
  })
  @ApiQuery({
    name: "questionId",
    required: true,
  ...
  @ApiOperation({
    ...
    description:
      "Total respondent count, percentage breakdown per option, and most popular answer.",
  })
  @ApiParam({
    name: "questionId",
    required: true,
