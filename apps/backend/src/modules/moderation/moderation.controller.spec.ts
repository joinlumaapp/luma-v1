...
describe("ModerationController", () => {
  ...
  describe("reportUser()", () => {
    ...
    it("should delegate to moderationService.reportUser with userId and dto", async () => {
      ...
      expect(mockModerationService.reportUser).toHaveBeenCalledWith(
        userId,
        dto,
      );
  ...
  describe("unblockUser()", () => {
    ...
    it("should throw NotFoundException when user is not blocked", async () => {
      ...
      await expect(
        controller.unblockUser(userId, "not-blocked"),
    ...
    it("should delegate to moderationService.unblockUser with userId and blockedUserId", async () => {
      ...
      expect(mockModerationService.unblockUser).toHaveBeenCalledWith(
        userId,
        blockedUserId,
      );
  ...
  describe("getBlockedUsers()", () => {
        ...
        blockedUsers: [
          {
            ...
            firstName: "Ali",
            photoUrl: null,
            blockedAt: "2025-06-01",
          },
          {
            userId: "user-3",
            firstName: "Ayse",
            photoUrl: "https://cdn.luma.app/thumb.jpg",
            blockedAt: "2025-05-20",
          },
        ],
        total: 2,
      };
    ...
    it("should delegate to moderationService.getBlockedUsers with userId", async () => {
      ...
      expect(mockModerationService.getBlockedUsers).toHaveBeenCalledWith(
        userId,
      );
