...
describe('MatchesService', () => {
  ...
  describe('generateConversationStarters()', () => {
    ...
    it('should return fallback starters when no high-scoring dimensions', async () => {
      ...
      expect(result.some((s: string) => s.includes('Merhaba') || s.includes('Selam'))).toBe(true);
    });
  ...
  describe('getAllMatches() — edge cases', () => {
      ...
      mockPrisma.match.findMany.mockResolvedValue([
        {
          ...
          userB: {
            id: 'u2',
            isSelfieVerified: false,
            profile: { firstName: 'Ayse', birthDate, city: 'Ankara', intentionTag: 'EXPLORING' },
            photos: [],
          },
          harmonySessions: [],
        },
    ...
    it('should include partner photo when available', async () => {
      const photo = { url: 'https://cdn.luma.app/photo.jpg', thumbnailUrl: 'https://cdn.luma.app/thumb.jpg' };
      mockPrisma.match.findMany.mockResolvedValue([
        {
          id: 'm1',
          userAId: 'u1',
      ...
      mockPrisma.match.findMany.mockResolvedValue([
        {
          ...
          userB: {
            id: 'u2',
            isSelfieVerified: false,
            profile: { firstName: 'Ayse', birthDate: new Date('1998-06-15'), city: 'Ankara', intentionTag: 'EXPLORING' },
            photos: [],
          },
          harmonySessions: [],
        },
      ...
      mockPrisma.match.findMany.mockResolvedValue([
        {
          ...
          isActive: true,
          createdAt: date2,
          userA: { id: 'u1', isSelfieVerified: true, profile: { firstName: 'Ali', birthDate: new Date('1995-01-01'), city: 'Istanbul', intentionTag: 'EXPLORING' }, photos: [] },
          userB: { id: 'u3', isSelfieVerified: true, profile: { firstName: 'Zeynep', birthDate: new Date('1997-03-20'), city: 'Izmir', intentionTag: 'SERIOUS_RELATIONSHIP' }, photos: [] },
          harmonySessions: [],
        },
        {
          id: 'm1',
          ...
          createdAt: date1,
          userA: { id: 'u1', isSelfieVerified: true, profile: { firstName: 'Ali', birthDate: new Date('1995-01-01'), city: 'Istanbul', intentionTag: 'EXPLORING' }, photos: [] },
          userB: { id: 'u2', isSelfieVerified: false, profile: { firstName: 'Ayse', birthDate: new Date('1998-06-15'), city: 'Ankara', intentionTag: 'EXPLORING' }, photos: [] },
          harmonySessions: [],
        },
      ]);
  ...
  describe('getMatch() — edge cases', () => {
    it('should return null breakdown when no compatibility score exists', async () => {
      mockPrisma.match.findUnique.mockResolvedValue({
        ...
        userB: {
          ...
          isSelfieVerified: true,
          isFullyVerified: true,
          profile: { firstName: 'Ayse', birthDate: new Date('1998-06-15'), bio: 'Hi', city: 'Ankara', country: 'TR', intentionTag: 'EXPLORING' },
          photos: [],
          badges: [],
        },
        harmonySessions: [],
    ...
    it('should include harmony session history in match detail', async () => {
      const sessions = [
        { id: 'hs-1', status: 'COMPLETED', startedAt: new Date(), actualEndedAt: new Date(), hasVoiceChat: true, hasVideoChat: false },
        { id: 'hs-2', status: 'ACTIVE', startedAt: new Date(), actualEndedAt: null, hasVoiceChat: false, hasVideoChat: true },
      ];
      mockPrisma.match.findUnique.mockResolvedValue({
        id: 'm1',
        userAId: 'u1',
    ...
    it('should return partner as userA when current user is userB', async () => {
      mockPrisma.match.findUnique.mockResolvedValue({
        ...
        userA: {
          ...
          isSelfieVerified: true,
          isFullyVerified: true,
          profile: { firstName: 'Mehmet', birthDate: new Date('1992-01-01'), bio: 'Hello', city: 'Izmir', country: 'TR', intentionTag: 'SERIOUS_RELATIONSHIP' },
