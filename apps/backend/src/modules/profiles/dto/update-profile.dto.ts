...
export class UpdateProfileDto {
  ...
  @ApiPropertyOptional({ description: 'Bio / About me text', minLength: 10, maxLength: 500 })
  @IsOptional()
  @IsString()
  ...
  @IsOptional()
  @IsEnum({ SERIOUS_RELATIONSHIP: 'SERIOUS_RELATIONSHIP', EXPLORING: 'EXPLORING', NOT_SURE: 'NOT_SURE' })
