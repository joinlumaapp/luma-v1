...
describe('VoiceIntroController', () => {
  ...
  describe('uploadVoiceIntro()', () => {
    ...
    it('should reject files > 5MB', async () => {
      ...
      await expect(controller.uploadVoiceIntro(userId, mockFile, dto)).rejects.toThrow(
        BadRequestException,
      );
    });
    ...
    it('should throw BadRequestException when no file is provided', async () => {
      ...
      await expect(controller.uploadVoiceIntro(userId, undefined, dto)).rejects.toThrow(
        BadRequestException,
      );
    });
