  ...
  async updateProfile(userId: string, dto: UpdateProfileDto) {
    ...
    const profile = await this.prisma.userProfile.upsert({
      ...
      update: {
        ...
        ...(dto.livingSituation !== undefined && { livingSituation: dto.livingSituation }),
        ...(dto.languages !== undefined && { languages: dto.languages }),
        ...(dto.sleepSchedule !== undefined && { sleepSchedule: dto.sleepSchedule }),
        ...(dto.diet !== undefined && { diet: dto.diet }),
        ...(dto.workStyle !== undefined && { workStyle: dto.workStyle }),
        ...(dto.travelFrequency !== undefined && { travelFrequency: dto.travelFrequency }),
        ...(dto.distancePreference !== undefined && { distancePreference: dto.distancePreference }),
        ...(dto.communicationStyle !== undefined && { communicationStyle: dto.communicationStyle }),
        ...(dto.hookah !== undefined && { hookah: dto.hookah }),
