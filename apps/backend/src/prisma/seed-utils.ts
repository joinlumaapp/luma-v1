...
export const TURKISH_CITIES: ReadonlyArray<{
  ...
  { name: 'Cesme', latitude: 38.3237, longitude: 26.3030 },
] as const;
...
export const INTEREST_TAGS: readonly string[] = [
  'Seyahat', 'Fotograf', 'Yemek Yapma', 'Muzik', 'Spor', 'Yoga',
  'Kitap', 'Film', 'Teknoloji', 'Doga', 'Dans', 'Sanat',
  'Tiyatro', 'Kahve', 'Sarap', 'Oyun', 'Kosu', 'Yuzme',
  'Bisiklet', 'Kamp', 'Dalga Sorfu', 'Dagcilik', 'Meditasyon',
  'Podcast', 'Blog Yazma', 'Gitar', 'Piyano', 'Resim',
  'Tasarim', 'Siir', 'Felsefe', 'Tarih', 'Bilim',
  'Astronomi', 'Bahcecilik', 'Geri Donusum', 'Hayvan Sevgisi',
  'Gonullu Calisma', 'Dil Ogrenme', 'Stand-Up', 'Pilates',
  'Boks', 'Tenis', 'Kayak', 'Soket', 'Futbol',
  'Basketbol', 'Motor', 'Klasik Araba', 'Koleksiyon',
] as const;
